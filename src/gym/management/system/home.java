...
public class home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("hulk gym welcomes you");
    ...
    private void jMenu5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu5MouseClicked
        ...
        int a = JOptionPane.showConfirmDialog(null, "You sure you want to Log Out?", "Select", JOptionPane.YES_NO_OPTION);
        if (a == 0)
        {
            setVisible(false);
    ...
    private void jMenu6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu6MouseClicked
        // TODO add your handling code here:
        int a = JOptionPane.showConfirmDialog(null, "You sure you want to Exit?", "Select", JOptionPane.YES_NO_OPTION);
        if (a == 0)
        {
            System.exit(0); 
        }
